...
IF(UNIX)  
  ...
  IF(CMAKE_SYSTEM_NAME STREQUAL AIX)
    IF(CMAKE_COMPILER_IS_GNUCC)
     ...
     SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-g -O3 ${COMMON_C_FLAGS}")
     SET(CMAKE_C_FLAGS_RELEASE        "-O3    ${COMMON_C_FLAGS}")
   ENDIF()
   IF(CMAKE_COMPILER_IS_GNUCXX)
     ...
     SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-g -O3 ${COMMON_CXX_FLAGS}")
